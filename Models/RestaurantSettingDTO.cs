...
namespace RestaurantMVC.Models
{
    public class RestaurantSettingDTO
    {
        ...
        public string Res_Close_Start_Date { get; set; }
        public string Res_Close_End_Date { get; set; }
        public string Res_Close_Message { get; set; }
        public string Res_Close_Message_Dan { get; set; }
        public int Res_Msg_No_of_Days { get; set; }
        public string Pickup_Close_Start_Date { get; set; }
        public string Pickup_Close_End_Date { get; set; }
        ...
        public string Delv_Close_Start_Date { get; set; }
        public string Delv_Close_End_Date { get; set; }
